...
const About = () => {
  return (
    ...
    <div class="container fluid p-4">
      ...
      <br/><p>A Full Stack Software Developer efficient in React JS, Java, MongoDB and SQL. <br/>Experienced in working over agile methodologies.<br/> Desirous of a development role in a positive and growth oriented environment. <br/> Committed to continuous learning and applying new technologies effectively.<br/><br/></p>
